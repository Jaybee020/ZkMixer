...
describe("Mixer", function () {
    ...
    it("should add to mixer and withdraw",async function(){
        ...
        var { proof, publicSignals } = await groth16.fullProve(Input, "circuits/Withdraw/Withdraw_js/Withdraw.wasm","circuits/Withdraw/circuit_final.zkey");
        ...
        expect(parseInt(recipientBalance)).to.equal(1E17)
